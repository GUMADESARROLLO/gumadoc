...
@section('scripts')
    @include('Documents.Regencia.Detalle.js_details')
@endsection
@section('content')
        ...
        <div class="col-12">
            <div class="overflow-hidden ">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item"><a class="nav-link px-2 px-md-3 active" id="specifications-tab" data-bs-toggle="tab" href="#tab-specifications" role="tab" aria-controls="tab-specifications" aria-selected="false">DOSSIERS ( {{ count($Documento->RegDossiers) }} )</a></li>
                    <li class="nav-item"><a class="nav-link px-2 px-md-3 " id="Certificados-tab" data-bs-toggle="tab" href="#tab-Certificados" role="tab" aria-controls="tab-Certificados" aria-selected="false">CERTIFICADOS ( {{ count($Documento->RegCertificados) }} )</a></li>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="tab-specifications" role="tabpanel" aria-labelledby="specifications-tab">
                        <div class="row align-items-center mt-3">
                            ...
                            <div class="col-auto">                
                                <button class="btn btn-falcon-default" type="button" id="btnUploadDossier">
                                    Cargar Dossier
                                </button>
                            </div>
                        </div>

                        @foreach ($Documento->RegDossiers as $Archivo)            
                    ...
                    <div class="tab-pane fade" id="tab-Certificados" role="tabpanel" aria-labelledby="Certificados-tab">
                        <div class="row align-items-center mt-3">
                            <div class="col">
                                <h5 class="mb-0"></h5>
                            </div>
                            <div class="col-auto">                
                                <button class="btn btn-falcon-default" type="button" id="btnUploadCertificado">
                                    Cargar Certificado
                                </button>
                            </div>
                        </div>

                        @foreach ($Documento->RegCertificados as $Archivo)            
                        <div class="row g-0 align-items-center border-bottom py-2 px-3">
                            <div class="col-md mt-1 mt-md-0">
                                <a href="../filePreview/{{ $Archivo->ADJUNTO }}" target="_blank" class="text-danger"> 
                                    <code> {{ explode(' - ', $Archivo->DOCUMENT_NAME)[1] ?? $Archivo->DOCUMENT_NAME  }} </code> </a>
