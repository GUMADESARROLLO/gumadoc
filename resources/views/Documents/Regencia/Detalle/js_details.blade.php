<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btnUploadDossier").click(function() {
            $("#staticBackdrop").modal("show");
            $("#staticBackdropLabel").html("CARGAR DOSSIERS");
            $("#cat_doc").val("DOSSIERS");
        });

        $("#btnUploadCertificado").click(function() {
            $("#staticBackdrop").modal("show");
            $("#staticBackdropLabel").html("CARGAR CERTIFICADOS");
