    ...
    <div class="container-fluid">        
        <div class="row min-vh-100 bg-100">
                    ...
                    <div class="col-lg-9 col-xl-8 col-xxl-6">                    
                        ...
                        <div class="card">
                            <div class="card-header bg-circle-shape bg-shape text-center p-2">
                                <a class="font-sans-serif fw-bolder fs-4 z-index-1 position-relative link-light light" href="#!">GUMADOCS</a>
                            </div>
            ...
            <div class="col-6 d-none d-lg-block position-relative">
                <div class="bg-holder" style="background-image:url(falcon/assets/img/generic/bg-gumadocs.jpg); background-position: 50% 20%;"></div>
            </div>
        </div>
    </div>
</main>
